...
/*       //\   /         Last Updated: Mon May 30 20:16:34 CEST 2022     */
/*      ||  '-'                                                          */
/* ********************************************************************* */
...
void	ClapTrap::attack(const std::string &target)
{
	...
	{
		std::cout << this->name << " (ClapTrap) tried to attack " << target << " but is running out of energy!" << std::endl;
		return;
	}
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << this->name << " took " << amount << " damages! (" << this->hp << "Hp remaining)" << std::endl;
}
