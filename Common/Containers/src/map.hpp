...
/*       //\   /         Last Updated: Tue Feb  7 17:25:47 CET 2023      */
/*      ||  '-'                                                          */
/* ********************************************************************* */
...
namespace ft {
	...
	class map
	{
		...
		protected:
			typedef value_type										tree_value;
			typedef ft::selector<value_type>						tree_selector;
			typedef BTree_Iterator<value_type>						tree_iterator;
			typedef BTree_Const_Iterator<value_type>				tree_const_iterator;
			typedef BTree<Key, value_type, tree_selector,
	...
	template < class K, class T, class Comp, class Alloc >
	void		swap(const map<K, T, Comp, Alloc> &l, const map<K, T, Comp, Alloc> &r)
		{ l.swap(r); }
